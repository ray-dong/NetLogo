...
public strictfp class Link
  ...
  public Agent realloc(Program oldProgram, Program newProgram) {
    ...
    Object[] variables = new Object[world().getVariablesArraySize(this, getBreed())];
  ...
  public int getBreedIndex() {
    ...
    int j = 1;
    for (Iterator<TreeAgentSet> iter = world().linkBreedAgents().values().iterator(); iter.hasNext();) {
